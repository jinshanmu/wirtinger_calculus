...
lemma Dplus_add_Dminus (f : H → W) (u : H) :
  ...
  simp only [DplusCLM, DminusCLM, ContinuousLinearMap.add_apply, ContinuousLinearMap.smul_apply,
    ContinuousLinearMap.sub_apply, smul_add, smul_sub, add_assoc, sub_eq_add_neg,
    add_left_comm, smul_neg, add_right_neg, zero_add]
  rw [← add_smul]
  norm_num
  rw [one_smul]
